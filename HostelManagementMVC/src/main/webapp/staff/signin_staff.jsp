				...
				<main class="form-signin">
					<form action="LoginStaffController" method="post">
						...
						<ul class="nav nav-pills navtab-bg nav-justified">
							<li class="nav-item"><a href="../student/signin_student.jsp"
								data-toggle="tab" aria-expanded="true" class="nav-link">Student</a>
							</li>
							<li class="nav-item"><a href="../staff/signin_staff.jsp"
								data-toggle="tab" aria-expanded="false" class="nav-link active">Staff</a>
							</li>
						</ul>
						<br>
						<br>
						...
						<div class="mb-3">
							<input type="text" class="form-control" placeholder="Staff No"
								name="stf_no" required>
						</div>
						<div class="mb-3">
							<input type="password" class="form-control"
								placeholder="Password" name="stf_pass" required>
						</div>
