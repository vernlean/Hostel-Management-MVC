						...
						<form action="UpdateStudentController" method="post">
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input class="form-control" type="text" id="stu_ic" name="stu_ic" value="${student.stu_ic}" required></div>
								<div class="col-md-6 mb-3">
									<label for="stu_no">Student Number</label> 
									<input class="form-control" type="text" id="stu_no" name="stu_no" value="${student.stu_no}" readonly>
								</div>
							</div>
							...
							<div class="mb-3">
								...
								<div class="input-group">
									...
									<input class="form-control" type="text" id="stu_name" name="stu_name" value="${student.stu_name}" required>
								</div>
							</div>

							<div class="mb-3">
								<label for="stu_email">Email <span class="text-muted">(Optional)</span></label>
								<input class="form-control" type="email" id="stu_email" name="stu_email" value="${student.stu_email}">
							</div>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<select class="form-control" id="stu_state" name="stu_state" required>
										<option value="${student.stu_state}">Current: ${student.stu_state}</option>
								...
								<div class="col-md-6 mb-3">
									...
									<select class="form-control" id="stu_gender" name="stu_gender" required>
										<option value="${student.stu_gender}">Current: ${student.stu_gender}</option>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input class="form-control" type="text" id="stu_part" name="stu_part" value="${student.stu_part}" required>
								</div>
								
								<div class="col-md-6 mb-3">
									<label for="stu_program">Programme</label> 
									<input class="form-control" type="text" id="stu_program" name="stu_program" value="${student.stu_program}" required>
								</div>
							</div>
							<div
								...
								<button type="button" class="btn btn-secondary" style="margin: 10px; padding: 5px 50px 5px 50px; border-radius: 10px;" onclick="window.location.href='ListAllStudentController'" >BACK</button>
							</div>
						</form>
					</div>
				</div>
